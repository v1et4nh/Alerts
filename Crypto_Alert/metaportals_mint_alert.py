...
NAME        = 'Catblox Metaportals'
PICKLE_FILE = '../Data/metaportals_last_counter.pickle'
ADDRESS     = '0xFc599783f1164155C60108a3b303Ce2f79CbA07d'
OPENSEA     = 'catbloxmetaportals'
TOTALSUPPLY = 'totalSupply'
MAXSUPPLY   = 'maxPortals'
MINTPRICE   = 0.01
BOT_CHATID  = '-1001767769373'
SLEEP       = 30
