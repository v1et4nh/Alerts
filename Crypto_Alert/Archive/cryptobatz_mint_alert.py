...
NAME        = 'CryptoBatz'
PICKLE_FILE = '../Data/cryptobatz_last_counter.pickle'
ADDRESS     = '0xc8adfb4d437357d0a656d4e62fd9a6d22e401aa0'
OPENSEA     = 'cryptobatz-by-ozzy-osbourne'
TOTALSUPPLY = 'totalSupply'
MAXSUPPLY   = 'CRYPTO_BATZ_SUPPLY'
if time.time() <= 1642719600:
    MINTPRICE = 0.088
else:
    MINTPRICE = 'getCurrentAuctionPrice'
PRICEFACTOR = 1000
BOT_CHATID  = '-1001750960231'
SLEEP       = 5
...
def run_mint_counter():
    ...
    if mint_counter - last_counter > 0:
        ...
        message = f"Minted: *{mint_counter}* | Holders: *{stats['num_owners']}*\n" \
                  ...
                  f"Floor Price: *{stats['floor_price']} ETH* ({floor_eur} EUR | {floor_usd} USD) *{price_x}x*\n" \
