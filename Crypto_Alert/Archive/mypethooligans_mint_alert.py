...
PICKLE_FILE = '../../Data/mypethooligan_last_counter.pickle'
ADDRESS     = '0x09233d553058c2F42ba751C87816a8E9FaE7Ef10'   # Crypto Champions
...
def getMaxSupply(dict_data):
    url = 'https://api.etherscan.io/api?module=proxy&action=eth_call&to='+dict_data['address']+'&data=0xd49d5181&apikey='+dict_data['key']
    data = getData(url)
