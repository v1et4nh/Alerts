...
PICKLE_FILE = '../Data/impftermin_biontech_last_messages.pickle'
SLEEP = 5


def main():
    url = "https://www.docvisit.de/kalender/blankenfeld/list?type=1558164"
    soup = get_soup(url)
    ...
    if not message:
        message = '*Biontech*: Keine Termine mehr verfügbar..\n\n'
        print(message)
    else:
        message = '*Biontech*: Es sind Impftermine verfügbar! - [Komplette Liste](' + url + ')\n\n' + message
